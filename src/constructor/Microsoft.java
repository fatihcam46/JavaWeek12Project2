...
public class Microsoft {
    public static void main(String[] args) {
       ...
       System.out.println(employeeOne.toString());
        //Employee{name='null', jobTitle='null', ID=0, salary=120000.0,company Name=Microsoft}

        employeeOne.name = "Ersin";
        employeeOne.ID = 100;
        employeeOne.jobTitle = "Technical Manager";
      System.out.println(employeeOne.toString());
 // Employee{name='Ersin', jobTitle='Technical Manager', ID=100, salary=120000.0,company Name=Microsoft}
        ...
        double maxSalary = Double.MIN_VALUE;//we need for loop
        for(Employee each: team){   // each is an Employee object
            if(each.salary>maxSalary){
                maxSalary = each.salary;
            }
        }
        System.out.println("maxSalary = " + maxSalary);//maxSalary = 120000.0
 ...
 */
        ...
        Employee.companyName = "Tesla";// companyName static oldgndn herkes degisiyor.
